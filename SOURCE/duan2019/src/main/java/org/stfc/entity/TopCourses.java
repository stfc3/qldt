...
public class TopCourses {
	...
	public TopCourses(Long evaluation, Long course, Integer coursePoint, String courseName, Integer point, String comment,
			String firstName, String lastName, String fullName, String phone, Long department) {
		super();
